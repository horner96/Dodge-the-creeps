## Changes Added
- Added four power ups that spawn during gameplay:
  - **Invincibility:** lets the player destroy enemies on contact for a short time.
  - **Screen Clear:** removes all enemies currently on screen.
